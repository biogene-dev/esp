...
# =========================================================================
mesureBalle=mat["mesureBalle"] # provient de 'Acquisition'
print ('lenmesuresballe =', len(mesureBalle))
...
#    print("indTestDebutB=,", indTestDebutB[ii])
    ...
    compteurLoc=0
    while (compteurLoc<1000) and (ang[indTestFin[ii]]<angMax): # max 1000 points
        indTestFin[ii]+=1;
        compteurLoc=compteurLoc+1; 
